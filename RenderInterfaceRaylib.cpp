...
namespace RmlUiRaylibRenderer
{
	void RenderGeometry(Rml::Vertex* vertices, int num_vertices, int* indices, int num_indices, const Rml::TextureHandle texture, const Rml::Vector2f& translation);
...
bool RmlUiRaylibRenderer::LoadTexture(Rml::TextureHandle& texture_handle, Rml::Vector2i& texture_dimensions, const Rml::String& source) {
	Texture2D rl_texture = ::LoadTexture(source.c_str());
